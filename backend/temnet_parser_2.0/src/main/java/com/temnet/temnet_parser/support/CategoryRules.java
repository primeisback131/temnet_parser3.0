...
public final class CategoryRules {
    ...
    private static final List<Category> CATEGORIES = List.of(
            ...
            new Category("Спец-ПО", List.of("консультант", "гарант", "фомс", "скзи")),
            new Category("Печать", List.of("принтер", "печат", "картридж", "сканер", "мфу", "kyocera")),
            new Category("Телефония", List.of("телефон", "атс", "sip", "звон")),
            new Category("Почта", List.of("почт", "п/я", "outlook", "ящик", "письм", "mail")),
            new Category("Удалёнка", List.of("vpn", "впн", "openvpn", "anydesk", "teamviewer", "rdp", "удаленн", "удалённ")),
            ...
            new Category("Оборудование", List.of("компьютер", "ноутбук", "монитор", "не включается", "клавиатур", "мышь"))
    );
